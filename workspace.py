...
class Workspace():
    def __init__(self, args):
        ...
        self.config = {
            ...
            'step_size': 40,
            'gamma': 0.5,
            'pretrained': 'mouth0.15_70',  # assgin baseModel when training baes model, mouth0.15_80 otherwise            
        
            # recovery config
            'temperature': 4, # weight of non-target class
            'alpha': 1,  # weight of soft loss
            'beta': 5,  # weight of featmap loss
