...
def show_batch(dl, save_dir):
    for images, _ in dl:
        ...
        ax.imshow(grid.permute(1, 2, 0))  # move the channel to the last dim to meet matplotlib requirement
        save_name = 'DataVisualization.png'
...
def calc_metrics(y_pred, y_true, y_scores):
    ...
    # print(y_true.max(), y_true.shape)
    # print(classes)
    # print('y_scores', y_scores, y_scores.shape)
